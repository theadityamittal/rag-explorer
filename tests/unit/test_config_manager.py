...
class TestConfigurationManager:
    ...
    def test_set_rag_config(self):
        ...
        self.manager.set_rag_config(
            confidence_threshold=0.6, max_chunks=8, max_chars_per_chunk=1200
        )
    ...
    def test_set_crawl_config(self):
        ...
        self.manager.set_crawl_config(
            allow_hosts=["example.com", "test.com"], depth=3, max_pages=100
        )
    ...
    def test_validate_config(self):
        ...
        )  # Should have warnings about low threshold and missing docs

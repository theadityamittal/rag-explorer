...
class TestE2ESystem:
    ...
    def test_reindex_and_search_flow(self):
        ...
        search_response = requests.post(f"{self.BASE_URL}/search", json={
            "query": "configuration",
            "k": 3
        })
    ...
    def test_ask_question_flow(self):
        ...
        # Ask a question
        ask_response = requests.post(f"{self.BASE_URL}/ask", json={
    ...
    def test_web_crawl_flow(self):
        ...
        crawl_response = requests.post(f"{self.BASE_URL}/crawl", json={
    ...
    def test_batch_ask_flow(self):
        ...
        batch_response = requests.post(f"{self.BASE_URL}/batch_ask", json={
            "questions": [
    ...
    def test_caching_behavior(self):
        ...
        # First request
        response1 = requests.post(f"{self.BASE_URL}/crawl", json={
            "urls": [url], 
            "force": False
        })
        
        # Second request (should use cache)
        response2 = requests.post(f"{self.BASE_URL}/crawl", json={
            "urls": [url], 
            "force": False
        })

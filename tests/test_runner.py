...
if __name__ == "__main__":
    ...
    parser.add_argument("--quick", action="store_true", help="Run quick tests (no slow/ollama tests)")
    parser.add_argument("--ollama", action="store_true", help="Run tests requiring Ollama")

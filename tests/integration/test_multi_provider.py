...
class TestMultiProviderIntegration:
    ...
    def test_provider_registration_integration(self):
        ...
        from support_deflect_bot_old.core.providers.config import get_default_registry
    ...
    def test_fallback_chain_building_integration(self):
        ...
        from support_deflect_bot_old.core.providers.base import ProviderType
        from support_deflect_bot_old.core.providers.config import get_default_registry
...
class TestRegionalComplianceIntegration:
    ...
    def test_gdpr_provider_filtering(self):
        ...
        from support_deflect_bot_old.core.providers.base import ProviderType
        from support_deflect_bot_old.core.providers.config import ProviderRegistry
        from support_deflect_bot_old.core.providers.implementations import (
            register_all_providers,
        )
...
class TestRealProviderIntegration:
    ...
    def test_groq_real_integration(self):
        ...
        from support_deflect_bot_old.core.providers.implementations import GroqProvider

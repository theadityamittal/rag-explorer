...
from src.utils.settings import APP_NAME, APP_VERSION, DEFAULT_SEEDS, CRAWL_DEPTH, CRAWL_MAX_PAGES, CRAWL_SAME_DOMAIN, DOCS_FOLDER
from src.data.web_ingest import index_urls, crawl_urls

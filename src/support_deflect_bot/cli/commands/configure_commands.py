...
def configure(ctx, reset: bool, quick: bool):
    ...
    try:
        ...
        if Confirm.ask("\nSave this configuration?", default=True):
            ...
            console.print("1. Run '[bold]python -m src.support_deflect_bot.cli.main ping[/bold]' to test provider connectivity")
            console.print("2. Run '[bold]python -m src.support_deflect_bot.cli.main index[/bold]' to index your documentation") 
            console.print("3. Run '[bold]python -m src.support_deflect_bot.cli.main ask[/bold]' to start asking questions")
        else:

...
class OllamaProvider(CombinedProvider):
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            available_models = [model['name'] for model in models['models']] if 'models' in models else []
            
            # Check if required models are available
            has_llm_model = any(self.default_llm_model in model for model in available_models)
            has_embedding_model = any(self.default_embedding_model in model for model in available_models)
